...
echo "<script>window.location='east.php'</script>";
}
?>
            ...
            <div class="row clearfix">
                <div class="col-lg-12">
                    ...
                    <a href="../dashboard"><img src="../images/prev.png" style="height:20px; width:30px;"><img src="../images/prev.png" style=" margin-right:10px;height:10px; width:20px;"></a>
                        <div class="header">
                            <h2><strong>Youth</strong>Volunteers /  East</h2>
...
include("../config/index.php");
  $stmt = $DB_con->prepare("SELECT * FROM request where province='east' and status='1' ");
  $stmt->execute();
...
?>
                        ...
                        <div class="header">
                            <h2><strong>Yv</strong> Co-ordinators / East </h2>
            ...
            <th>N.ID</th>
                                    ...
                                    <tbody>
                                    	 <?php
include("../config/index.php");
  $stmt = $DB_con->prepare("SELECT * FROM customer where province='east'  ORDER BY id desc");
  $stmt->execute();
