            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);"> Denied Requests </a></li>
                        <li class="breadcrumb-item active"> Denied list </li>
                    </ul>
                    <br>
...
include("../config/index.php");
  $stmt = $DB_con->prepare("SELECT * FROM request where status='2' and sector='$sector' order by id asc ");
  $stmt->execute();
         ...
         <th >ID</th>
            ...
            <th>action</th>
                                    ...
                                    <tbody>
                                    	...
                                    	<?php
include("../config/index.php");
  $stmt = $DB_con->prepare("SELECT * FROM request where status='2' and district='$district'  order by id asc ");
  $stmt->execute();
         ...
         <th >ID</th>
            ...
            <th>action</th>
                                    ...
                                    <tbody>
                                    	...
                                    	<?php
include("../config/index.php");
  $stmt = $DB_con->prepare("SELECT * FROM request where status='2'  order by id asc ");
  $stmt->execute();
