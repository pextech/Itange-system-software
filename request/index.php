            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0);">Youth volunteers Requests </a></li>
...
include("../config/index.php");
  $stmt = $DB_con->prepare("SELECT * FROM request where status='0' and sector='$sector' order by id asc ");
  $stmt->execute();
    ...
    while($row=$stmt->fetch(PDO::FETCH_ASSOC))
    {
      ...
      ?>
         ...
         <td><?= $sector ; ?></td>
          ...
          <td><a class="btn btn-info" href="?approve_id=<?=$id ?>" title="click to Approve" onclick="return confirm('Are you sure to Approve <?=$name; ?>?')"><div class="icon-circle ">yes</div></a>
          <a class="btn btn-danger" href="?deny_id=<?=$id ?>" title="click to denie" onclick="return confirm('Are you sure to deny <?=$name; ?>?')"><div class="icon-circle bg-red">no</div></a></td>
         ...
         <th >ID</th>
            ...
            <th>action</th>
                                    ...
                                    <tbody>
                                    	...
                                    	<?php
include("../config/index.php");
  $stmt = $DB_con->prepare("SELECT * FROM request where status='0' and district='$district'  order by id asc ");
  $stmt->execute();
         ...
         <th >ID</th>
            ...
            <th>action</th>
                                    ...
                                    <tbody>
                                    	...
                                    	<?php
include("../config/index.php");
  $stmt = $DB_con->prepare("SELECT * FROM request where status='0'  order by id asc ");
  $stmt->execute();
